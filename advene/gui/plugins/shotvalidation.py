...
class ShotValidation(AdhocView):
    ...
    def set_annotationtype(self, at):
        ...
        self.annotations = list(at.annotations)
    ...
    def goto_current(self, *p):
        ...
        l=[ a for a in self.annotations if p >= a.begin and p <= a.end ]
        if l:
    ...
    def build_widget(self):
        ...
        self.selector = FrameSelector(self.controller, self.annotations[0].begin)
        ...
        def handle_index_change(adj):
            ...
            if i >= 0 and i <= len(self.annotations) - 1:
                ...
                self.selector.set_timestamp(a.begin)
